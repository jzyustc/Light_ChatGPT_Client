...
class TestTWindow(QWidget):
	...
	def display_UI(self):
		...
		self.no_chat_image_block.setFixedSize(self.w, self.display_h - 20)
		...
		self.no_chat_image.setFont(self.font_background)
	...
	def ask_question(self):
		...
		self.add_display_item(text+"_"+new_chat, "#f7f7f8"),
